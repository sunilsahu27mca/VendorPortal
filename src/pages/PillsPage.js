...
import { MDBContainer, MDBRow, MDBCol, MDBTabPane, MDBTabContent, MDBNav, MDBNavItem, Link } from 'mdbreact';
            ...
            <MDBCol md='12'>
              <SectionContainer header='Basic example'>
                <MDBNav className='nav-pills'>
                  <MDBNavItem>
                    <Link to='#' active={activeItemPills === '1'} onClick={this.togglePills('1')} link>
                      Home
                    </Link>
                  </MDBNavItem>
                  <MDBNavItem>
                    <Link to='#' active={activeItemPills === '2'} onClick={this.togglePills('2')} link>
                      Profile
                    </Link>
                  </MDBNavItem>
                  <MDBNavItem>
                    <Link to='#' active={activeItemPills === '3'} onClick={this.togglePills('3')} link>
                      Contact
                    </Link>
                  </MDBNavItem>
                </MDBNav>
